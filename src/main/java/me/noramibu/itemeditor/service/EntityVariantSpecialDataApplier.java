...
final class EntityVariantSpecialDataApplier extends AbstractPreviewApplierSupport implements SpecialDataApplier {
    ...
    public void apply(SpecialDataApplyContext context) {
        ...
        this.applyHolderComponent(context, DataComponents.CAT_SOUND_VARIANT, Registries.CAT_SOUND_VARIANT, current.entityCatSoundVariant, baseline.entityCatSoundVariant, "special.entity_variant.cat_sound_variant");
        this.applyHolderComponent(context, DataComponents.CHICKEN_VARIANT, Registries.CHICKEN_VARIANT, current.entityChickenVariant, baseline.entityChickenVariant, "special.entity_variant.chicken_variant");
        this.applyHolderComponent(context, DataComponents.CHICKEN_SOUND_VARIANT, Registries.CHICKEN_SOUND_VARIANT, current.entityChickenSoundVariant, baseline.entityChickenSoundVariant, "special.entity_variant.chicken_sound_variant");
        ...
        this.applyHolderComponent(context, DataComponents.COW_SOUND_VARIANT, Registries.COW_SOUND_VARIANT, current.entityCowSoundVariant, baseline.entityCowSoundVariant, "special.entity_variant.cow_sound_variant");
        ...
        this.applyHolderComponent(context, DataComponents.PIG_SOUND_VARIANT, Registries.PIG_SOUND_VARIANT, current.entityPigSoundVariant, baseline.entityPigSoundVariant, "special.entity_variant.pig_sound_variant");
